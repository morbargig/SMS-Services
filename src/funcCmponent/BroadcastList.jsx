        ...
        <div>
         ...
         <br></br>  name , phoneNumber   <br></br>
            and separate by new line
                ...
                <textarea placeholder={correnetUsers ? correnetUsers.length + ' users: \n' + correnetUsers.map(n => n[0]  +'-0' + n[1]+ "  ") : "users"} name='listOfUsers' value={listOfUsers} rows="4" cols="50" onChange={handleChange}>
